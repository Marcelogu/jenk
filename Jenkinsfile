            ...
            steps {
                script {
                    withCredentials([usernamePassword(credentialsId: 'id-de-credenciales-del-registry', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]) {
                        ...
                        sh "docker build -t registry.gitlab.com/marceloguzman1/prueba1/mi-imagen-nodejs:alpine3.18 ."
                        sh "docker push registry.gitlab.com/marceloguzman1/prueba1/mi-imagen-nodejs:alpine3.18"
                    }
